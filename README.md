## This is my repository for VRV Security's Assignment

## The entire code is in the script.py file.

## There is also the sample.log provided and the generated output csv file.
